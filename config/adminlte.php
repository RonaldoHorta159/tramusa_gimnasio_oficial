...
return [
    ...
    */
    ...
    'logo' => '<b>Tramusa</b>Gimnasio',
    'logo_img' => 'vendor/adminlte/dist/img/logo-tramusa.png',
    ...
    */
    ...
    'auth_logo' => [
        'enabled' => true,
        'img' => [
            'path' => 'vendor/adminlte/dist/img/logo-tramusa.png',
            'alt' => 'Auth Logo',
            'class' => '',
            'width' => 200,
            'height' => 100,
    ...
    */
    'classes_auth_card' => '',
    'classes_auth_header' => 'bg-gradient-white',
    'classes_auth_body' => '',
    'classes_auth_footer' => 'text-center bg-gradient-white',
    ...
    */
    ...
    'menu' => [
        ...
        //     'label_color' => 'success',
        // ],
        ['header' => 'AADMINISTRACION CLIENTES'],
        [
            'text' => 'Clientes',
            'route' => 'cliente.index',
    ...
    */
    ...
    'plugins' => [
        ...
        'Moment' => [
            'active' => true, // Activar para el componente de fecha
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                ...
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdnjs.cloudflare.com/ajax/libs/moment.js/2.29.4/moment-with-locales.min.js', // Para soporte de idiomas como español
                ],
            ],
        ],
        'TempusDominusBs4' => [
